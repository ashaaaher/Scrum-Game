 ...
 */
public class Screen extends World implements Receiver 
{
     ...
     * if you enable it.
     */
    public Screen(double scale, boolean depth)
    {
     ...
     */
    public Screen(int thumbnailWidth, int thumbnailHeight, double scale, boolean depth)
    {
        //super((int)(KinectClient.DEFAULT_IMAGE_WIDTH * scale), (int)(KinectClient.DEFAULT_IMAGE_HEIGHT * scale), 1); 
        super(700,600, (int)scale,depth); 
    ...
    public void display () {
        System.out.println("invoking display on Screen" + this); 
